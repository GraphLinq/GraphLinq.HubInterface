...
function LaunchpadStepInfos() {
  ...
  const handleSubmit = () => {
    if (projectNameEmpty || descriptionEmpty || websiteLinkEmpty || raiseTokenEmpty || saleTokenEmpty) {
      return;
    }
  ...
  return (
    <div className="launchpadStep">
        ...
        <Button disabled={projectNameEmpty || descriptionEmpty || websiteLinkEmpty || raiseTokenEmpty || saleTokenEmpty} onClick={() => handleSubmit()}>Next</Button>
    </div>
  );
}
